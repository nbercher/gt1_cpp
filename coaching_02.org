...
- [[#pour-bien-travailler-tous-ensemble][Pour bien travailler tous ensemble]]
  - [[#votre-espace-de-travail-dans-wsl][Votre espace de travail dans WSL]]
  - [[#githubcom-en-mode-privé][Github.com en mode privé]]
- [[#c-programmation-orientée-objet][C++: Programmation orientée objet]]
...
- [[#révision-git-add-commit-push-etc][Révision Git (add, commit, push, etc.)]]
- [[#exercices][Exercices]]
- [[#objectifs-pour-le-prochain-coaching][Objectifs pour le prochain coaching]]
- [[#ressources][Ressources:]]
#+END_QUOTE

* *URGENCE ABSOLUE*: Élèves bloqués avec leur compte Windows non-admin :TODOélèves:
*Groupe A seulement*
...
* Pour bien travailler tous ensemble                             :TODOélèves:
** Votre espace de travail dans WSL
...
* Révision Git (add, commit, push, etc.)
